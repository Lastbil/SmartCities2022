...
C = np.diag([0, C['Concrete'], 0, C['Insulation'], 0, 0, 0, C['Concrete'], C['Air'], C['Glass']])
print(C)

# C = np.diag([0, C['Concrete'], 0, C['Insulation'], 0, 0, 0, 0])

#------- More written MATRIXES -----------------------------------------------
F0 = 100 #put right values
F1 = 100
Q_a = 30
Q_b = 40
...
#C = np.array([0, C0, 0, C1, 0, 0, 0, C2, C3, C4])
...
# Step response
# -------------
duration = 3600 * 24 * 1        # One day in [s]
# number of steps
